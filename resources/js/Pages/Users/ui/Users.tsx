...
import MakeManager from '@/Pages/Users/partials/MakeManager'
import MakeUserPayment from '@/Pages/Users/partials/MakeUserPayment'
      ...
      header={
        <div className="flex justify-between flex-wrap">
          ...
          <div className="flex gap-2">
            <MakeManager users={users.data} />
            <MakeUserPayment users={users.data} />
            <AddUserModal />
          </div>
        </div>
      }
